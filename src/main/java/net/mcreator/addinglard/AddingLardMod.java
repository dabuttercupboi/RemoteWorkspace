 ...
 *
 */
package net.mcreator.addinglard;
...
@Mod("adding_lard_")
public class AddingLardMod {
	public static final Logger LOGGER = LogManager.getLogger(AddingLardMod.class);
	public static final String MODID = "adding_lard_";

	public AddingLardMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		AddingLardModBlocks.REGISTRY.register(bus);
		...
		AddingLardModFluids.REGISTRY.register(bus);
		AddingLardModFluidTypes.REGISTRY.register(bus);
	}
