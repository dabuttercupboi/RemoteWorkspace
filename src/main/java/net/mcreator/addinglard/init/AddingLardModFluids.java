...
import net.mcreator.addinglard.fluid.PeeFluid;
import net.mcreator.addinglard.AddingLardMod;

public class AddingLardModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, AddingLardMod.MODID);
